        ...
        <div className="flex flex-col items-start justify-between h-full p-4">
          ...
          <div className="flex flex-col gap-1 text-[#FFFFF0] text-sm">
            <span className="flex items-center gap-1">
              <img src="/src/assets/assetsvivit/person_outline.svg" alt="Instructor" className="w-4 h-4" />
              {instructor}
            </span>
            <span className="flex items-center gap-1">
              <img src="/src/assets/assetsvivit/video_library.svg" alt="Videos" className="w-4 h-4" />
              {videoCount} Video
            </span>
            <span className="flex items-center gap-1">
              <img src="/src/assets/assetsvivit/star.svg" alt="Rating" className="w-4 h-4" />
              {rating}/5
            </span>
          </div>
        </div>
