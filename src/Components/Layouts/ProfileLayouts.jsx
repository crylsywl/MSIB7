...
const ProfileLayouts = (props) => {
    ...
    return (
        <div className="font-sans">
            <img className="w-full mt-[64px] h-[250px] object-cover" src="/assets/Banner.jpg" />
            <img className="rounded-full absolute object-cover w-[185px] h-[185px] top-[193px] left-[270px] translate-x-[-50%]" src="/assets/Profile.jpg" alt="" />
