...
const Elearning = () => {
  ...
  const filteredContents = contents.filter(
    (content) =>
      (filterValue === "all" ||
        content?.Categori?.toLowerCase().includes(filterValue.toLowerCase())) &&
  ...
  return (
    <div>
      ...
      <img
        src="/assets/assets/Banner eleerning.png"
        alt=""
      ...
      <div className=" -mt-[245px] mb-[20px]">
        <div className="w-full h-[245px] px-[150px] py-[50px] bg-black bg-opacity-50 flex-col justify-start items-start gap-2.5 inline-flex">
          <div className="h-[145px] flex-col justify-start items-start gap-3 flex">
            <div className="text-[#fffff0] text-[40px] font-bold font-['Plus Jakarta Sans'] leading-[44px] opacity-100">
              Persiapkan Diri Lebih Baik, <br />
              Mulai Karier dengan Percaya Diri!
            </div>
            <div className="self-stretch h-[45px] text-[#fffff0] text-lg font-normal font-['Plus Jakarta Sans'] opacity-100 leading-snug">
              Dapatkan panduan lengkap membuat CV yang menarik, membangun
              portfolio profesional, dan menghadapi interview kerja dengan
              percaya diri. Pelajari juga soal-soal umum psikotes untuk semakin
