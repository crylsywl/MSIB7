      ...
      <main className="mb-[60px]">
        <div className="mx-[150px] h-[100vh] items-center gap-[32px] flex justify-between">
          <div className="w-1/2 flex flex-col gap-[30px]">
            <h1 className="text-black text-[40px] font-bold font-['Plus Jakarta Sans'] leading-[44px]">
              Siapkan Dirimu untuk Karier Impian dengan Persiapan yang Tepat!
            </h1>
            <h6 className="text-black text-lg font-normal font-['Plus Jakarta Sans'] leading-snug">
            ...
            <Link to="Program Kami" smooth={true} duration={500}>
              <Button classname="h-fit py-1 shadow-[inset_0px_-4px_10px_rgba(0,_0,_0,_0.3)] transition  hover:shadow-[inset_0px_4px_10px_rgba(0,_0,_0,_0.3)] hover:bg-[#fdab7f] w-fit  px-[18px] text-[#fffff0] text-lg bg-[#fb6816] rounded-[15px] justify-center items-center">
                Gabung Sekarang
              </Button>
            </Link>
            <div className="flex gap-[8px]">
              ...
              <div className="flex flex-col">
                <h6 className="text-black text-base font-bold font-['Plus Jakarta Sans'] leading-[19px]">
          ...
          <div className="w-1/2">
            <img src="/assets/Banner Homepage.jpg" alt="" />
          </div>
        </div>
        <div className="mx-[150px] mt-[60px] items-center gap-[32px] flex justify-center">
          <div className="flex items-center gap-[10px] flex-col w-auto h-fit shadow-xl rounded-md p-[20px] hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out">
            <img
              src="/assets/Karier.svg"
              alt=""
              className="w-[147px] h-[147px]"
            />
            <h6 className="text-center text-black text-2xl font-semibold font-['Plus Jakarta Sans'] leading-relaxed tracking-tight">
              Persiapan Karier
            </h6>
            <h6 className="text-center line-clamp-4 text-black text-base font-normal font-['Plus Jakarta Sans'] leading-snug">
              Dapatkan panduan lengkap untuk fresh graduate, mulai dari review
              CV, peningkatan portfolio, hingga latihan interview.
            </h6>
          </div>
          <div className="flex items-center gap-[10px] flex-col w-auto h-fit shadow-xl rounded-md p-[20px] hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out">
            <img
        ...
        <div
          name="Program Kami"
          className="flex justify-center mt-[60px] bg-[#4C37EE] items-center gap-[32px] flex-col w-auto h-fit shadow-xl pb-[40px] mx pt-[20px]"
        >
          <h1 className="text-[#fffff0] text-[32px] font-semibold font-['Plus Jakarta Sans'] underline leading-[38.40px]">
            Program Kami
          </h1>
          <div className="flex mx-[150px] w-[1140px] gap-[20px] items-center justify-center">
            ...
            <div className="flex flex-col gap-[10px] w-1/2 justify-center items-start">
              <h1 className="text-[#fffff0] text-[32px] font-semibold font-['Plus Jakarta Sans'] leading-[38.40px]">
                Mentoring
              </h1>
              <h6 className="text-[#fffff0] text-lg font-normal font-['Plus Jakarta Sans'] leading-snug">
              ...
              <Button
                type="Link"
                to={"/mentoring"}
                classname="py-1 h-fit shadow-[inset_0px_-4px_10px_rgba(0,_0,_0,_0.3)] transition  hover:shadow-[inset_0px_4px_10px_rgba(0,_0,_0,_0.3)] hover:bg-[#adffeb] w-fit  px-[18px] text-[#3725c2] text-lg bg-[#23ffca] rounded-[15px] justify-center items-center"
              >
                Lihat Lainnya
              </Button>
            </div>
          ...
          <div className="flex w-[1140px] gap-[20px] justify-between">
            <div className="flex flex-col gap-[10px] w-1/2 justify-center items-end">
              ...
              <h6 className="text-[#fffff0] text-lg text-right font-normal font-['Plus Jakarta Sans'] leading-snug">
            ...
            <div className="flex items-center justify-center w-1/2">
              ...
              >
                <img
                  src="/assets/elearning back 1.jpg"
                  alt=""
                  className="w-[195px]"
                />
              </motion.div>
              ...
              >
                <img
                  src="/assets/elearning front.jpg"
                  alt=""
                  className="w-[195px] z-10 "
                />
              </motion.div>
              ...
              >
                <img
                  src="/assets/elearning back 2.jpg"
                  alt=""
                  className="w-[195px]"
                />
              </motion.div>
        ...
        <div className="mx-[150px] gap-[20px] mt-[60px]">
          <h1 className="text-center text-black text-[32px] font-semibold font-['Plus Jakarta Sans'] underline leading-[38.40px]">
            Mentor Kami
          </h1>
          <Slider {...settings}>
            {data.map((e) => (
              <div className=" mt-[20px] h-auto p-5 bg-[#fb6816] rounded-[10px] shadow flex-col justify-start items-center gap-[4px] inline-flex">
                <img
                  src={e.image}
                  alt=""
                  className="w-full h-[233px] rounded-md object-cover"
                />
                <p className="text-center text-[#fffff0] text-xl font-semibold font-['Plus Jakarta Sans'] leading-snug tracking-tight">
                  {e.Name}
                </p>
                <p className="text-center text-[#fffff0] text-base font-normal font-['Plus Jakarta Sans'] leading-[19px]">
                  {" "}
                  {e.Profesi}
                </p>
              </div>
...
const data = [
  {
    Name: "Tiara Dewi",
    image: "/assets/Tiara Dewi.jpg",
    Profesi: "CV Consultant",
  },
  {
    Name: "Raka Nugraha",
    image: "/assets/Raka Nugraha.jpg",
    Profesi: "Portfolio Advisor",
  },
  {
    Name: "Nadia Kurnia",
    image: "/assets/Nadia Kurnia.jpg",
    Profesi: "HR Specialist",
  },
  {
    Name: "Maya Putri",
    image: "/assets/Maya Putri.jpg",
    Profesi: "Portfolio Advisor",
  },
  {
    Name: "Rian Utama",
    image: "/assets/Rian Utama.jpg",
    Profesi: "HR Consultant",
  },
  {
    Name: "Siska Larasati",
    image: "/assets/Siska Larasati.jpg",
    Profesi: "CV Consultant",
  },
];
