...
const Artikel = () =>{
    ...
    return (
        <div>
            <Navbar />
            <img src="/assets/artikelbanner.png" alt="" className="w-full h-[300px] object-cover mt-[62px]" />
    ...
    <div className='grid grid-cols-1 min-h-[800px] mt-[20px] ml-[150px]'>
            <ArtikelList artikels={filteredArtikels} />
                    ...
                    <img src='/assets/cardungu.svg' className="w-[201.80px] h-[153.37px] relative"/>
                    <div className="self-stretch h-40 flex-col justify-start items-center gap-[17px] flex">
                        <div className="self-stretch h-[108px] flex-col justify-start items-center gap-5 flex">
                            ...
                            <Button type ='Link'to='/mentoring' classname=" bg-teal-300 item-center hover:shadow-[inset_0px_4px_10px_rgba(0,_0,_0,_0.3)] hover:bg-[#adffeb] shadow-[inset_0px_-4px_10px_rgba(0,_0,_0,_0.3)] flex justify-center text-cente items-center">Selengkapnya</Button>
                    </div>
                    <div className="w-[476px] h-[177px] flex-col justify-start items-start gap-4 inline-flex mt-[72px]">
                            ...
                            <div className="">
                                <Button type ='Link'to='/elearning' className=" gap-2 w-[167px] px-4 text-[#fffff0] font-semibold py-1 bg-[#fb6816] rounded-[20px] item-center hover:shadow-[inset_0px_4px_10px_rgba(0,_0,_0,_0.3)] hover:bg-[#FDAC7F] shadow-[inset_0px_-4px_10px_rgba(0,_0,_0,_0.3)] flex justify-center text-cente items-center">E-Learning</Button>
                            </div>
                        </div>
                </div>
                <Footer />
